...
@section('content')
    <div class="row" style="margin:0px auto;">
        <div class="col-md-9">
            ...
            <form method="POST" action="{!! url('catagory/'.$CatEdit['id']) !!}" accept-charset="UTF-8">
                {{ csrf_field() }}
                {!! method_field('PUT')!!}
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <strong></strong>
                            <input placeholder="Title" class="form-control" name="title" type="text" value="<?php if (isset($CatEdit)) echo $CatEdit['title'];?>">
                        </div>
                    </div>
