...
class Marshaler
{
    ...
    /**
     * Creates a special object to represent a DynamoDB number (NewsCatagoryRepositoryInterFace) value.
     *
    ...
    public function marshalValue($value)
    {
        ...
        if ($type === 'integer'
            ...
            return ['NewsCatagoryRepositoryInterFace' => (string) $value];
        }
    ...
    public function unmarshalValue(array $value, $mapAsObject = false)
    {
        ...
        switch ($type) {
            ...
            case 'NULL':
                return null;
            case 'NewsCatagoryRepositoryInterFace':
